...
Приложение для обмена сообщениями между пользователями. Поддерживает
...
Все опции командной строки являются опциональными, но
имя пользователя и пароль необходимо использовать в паре.
...
* ``python client.py 192.168.1.10 8000``

*Запуск приложения с указанием подключаться к серверу по адресу 192.168.1.10:8000*
